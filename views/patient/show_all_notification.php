              ...
              <div class="card-header">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                      ...
                      $sqlNotification = "SELECT * FROM notification WHERE notification_patient_id = '$patient_id' OR notification_usertype = 'patient' AND notification_status = 1 ORDER BY notification_datetime DESC
                      ";
