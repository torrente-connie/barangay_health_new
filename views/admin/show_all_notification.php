              ...
              <div class="card-header">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                      ...
                      $sqlNotification = "SELECT * FROM notification WHERE notification_usertype = 'admin' OR notification_admin_id = '$admin_id' AND notification_status = 1 ORDER BY notification_datetime DESC
                      ";
