          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item active dropdown">
                    ...
                    <ul class="dropdown-menu" style="display: none;">
                      ...
                      <li class="nav-item active"><a href="accounts_bhw.php" class="nav-link"> <span>Barangay Health Worker</span> </a></li>
                    </ul>
                </li>
      ...
      <div class="main-content" style="min-height: 566px;">
        <section class="section">
          <div class="section-header">
            <h1>Barangay Health Worker Accounts</h1>
            </div>
              ...
              <div class="card-header">
                 <h4></h4>
                  <div class="card-header-action">
                    <a href="add_accounts_bhw.php" class="btn btn-success btn-sm">Add Barangay Health Worker</a>
                  </div>
              </div>
