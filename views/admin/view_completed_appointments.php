...
<body class="layout-3">
                      ...
                      ?>
                        ...
                        <tr>
                         ...
                         <!--  <td><?php //echo $appoint_schedule_date ?></td>
                          ...
                          <td>
                                <button class="btn btn-info btn-sm btn-block completedAppointmentAdmin" id='<?php echo $appointment_id ?>'> View Details </button> 
                          </td> 
                          <td>
 ...
 <!-- Modal for View Appointment Details -->
       <div class="modal fade" tabindex="-1" role="dialog" id="completedAppointmentAdmin">
...
<script type="text/javascript">
  $(document).ready(function(){
    $(document).on('click','.completedAppointmentAdmin', function(){
        ...
        $.ajax({
          url:"../../backend/admin_appointment_complete.php",
            ...
            success:function(data) {
                ...
                $('#completedAppointmentAdmin').modal('show');
             }
        })  
    })
});
