...
<body class="layout-3">
  <div id="app">
                      ...
                      ?>
                        ...
                        <tr>
                         ...
                         <!--  <td><?php //echo $appoint_schedule_date ?></td>
                          ...
                          <td>
                                <button class="btn btn-info btn-sm btn-block completedAppointmentBhw" id='<?php echo $appointment_id ?>'> View Details </button> 
                          </td> 
                          <td>
    ...
    <!-- Modal for View Appointment Details -->
       <div class="modal fade" tabindex="-1" role="dialog" id="completedAppointmentBhw">
...
<script type="text/javascript">
  $(document).ready(function(){
    $(document).on('click','.completedAppointmentBhw', function(){
        ...
        $.ajax({
          url:"../../backend/bhw_appointment_complete.php",
            ...
            success:function(data) {
                ...
                $('#completedAppointmentBhw').modal('show');
             }
        })  
    })
});
