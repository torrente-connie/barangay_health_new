<?php 
	...
	$displayCurrentUserInfo = "SELECT * FROM user WHERE user_type = 'Barangay Health Worker' AND user_id = '$bhw_id'";
					...
					<div class="section-body">
						<div class="row mt-sm-4">
							...
							<div class="col-12 col-md-12 col-lg-7">
								<div class="card">
									<form action="../../backend/bhw_profile.php" method="POST" enctype="multipart/form-data">
										<div class="card-header">
											<h4>Edit Profile</h4>
										</div>
										<div class="card-body">

												<input type="hidden" name="user_id" value="<?php echo $bhw_id ?>">
										...
										<div class="card-footer text-right">
											<button class="btn btn-primary" type="submit" name="editBhwProfile">Save Changes</button>
