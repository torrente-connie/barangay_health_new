<?php 
  ...
  // SQL Query for Pending F2f Appointments
  $sql1 = "SELECT * FROM appointment WHERE appointment_type = 'bookappointment' AND appointment_status = 1 ";
  $result1 = mysqli_query($connection,$sql1);
  $numrows1 = mysqli_num_rows($result1);

  // SQL Query for Pending Virtual Consultations
  $sql2 = "SELECT * FROM appointment WHERE appointment_type = 'onlineappointment' AND appointment_status = 1 ";
  $result2 = mysqli_query($connection,$sql2);
  $numrows2 = mysqli_num_rows($result2);

  // SQL Query for Pending Walk-in Appointments
  $sql3 = "SELECT * FROM appointment WHERE appointment_type = 'walkinappointment' AND appointment_status = 1 ";
...
<body class="layout-3">
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-12">
              <div class="card card-statistic-1">
                ...
                <div class="card-wrap">
                  <div class="card-header">
                    <h4>Face to Face Appointments</h4>
                  </div>
                  <div class="card-body">
                    <?php echo $numrows2 ?> 
                  </div>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive table-invoice">
                    <table class="table table-striped">
                      ...
                      a.appointment_patient_id as appointment_patient_id
                      FROM appointment a
                      JOIN user d 
                      ...
                      WHERE a.appointment_status IN (7,14) 
                      ...
                      ?>
                        ...
                        <tr>
                         ...
                         <!--  <td><?php //echo $appoint_schedule_date ?></td>
                          ...
                          <td>
                                <button class="btn btn-info btn-sm btn-block onGoingAppointmentBhw" id='<?php echo $appointment_id ?>'> View Details </button> 
                          </td> 
                          <td>
 ...
 <!-- Modal for View Appointment Details -->
       <div class="modal fade" tabindex="-1" role="dialog" id="onGoingAppointmentBhw">
...
<script type="text/javascript">
  $(document).ready(function(){
    $(document).on('click','.onGoingAppointmentBhw', function(){
        var viewID = $(this).attr("id");
        $.ajax({
          url:"../../backend/bhw_appointment_complete.php",
            method:"POST",
            ...
            success:function(data) {
                ...
                } else if(data.appointment_status == 14) {
                  $('#view_appoint_status').html("<span class='badge badge-primary badge-pill'>Confirmed</span>");
                }
                ...
                $('#onGoingAppointmentBhw').modal('show');
             }
        })  
    })
});
